...
import { TextField, Grid, Button, Box, FormControl, InputLabel, MenuItem, Select } from '@mui/material';
...
const injuriesArr = ['Артилерія', 'Тупим предметом', 'Міни', 'Опіки', 'Перелам', 'ДТП', 'GSW', 'RPG', 'IED', 'Уламки'];
...
export const SecondaryInfo = ({
  ...
  return (
    <form onSubmit={handleSecondaryInfoSubmit} style={{ margin: '25px' }}>
      ...
      <Button
        type="submit"
        onClick={handleSecondaryInfoSubmit}
        variant="contained"
        color="primary"
        style={{ margin: '20px' }}>
        Надіслати
